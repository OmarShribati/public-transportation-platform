...
def vehicle_data(vehicle):
    ...
    latest_location = (
        active_trip.locations.order_by('-recorded_at').first()
        if active_trip
        else None
    )
    ...
    return {
        ...
        'scanner_device': (
            {
                'device_id': vehicle.scanner_device.device_id,
                'device_code': vehicle.scanner_device.device_code,
                'status': vehicle.scanner_device.status,
            }
